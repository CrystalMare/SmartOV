<nav class="nav">
    <div class="container">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a href="gekoppelde-kaarten" class="nav-link">Gekoppelde kaarten inzien</a></li>
            <li class="nav-item"><a href="gekoppelde-kaarten-toevoegen" class="nav-link">Gekoppelde kaarten toevoegen</a></li>
        </ul>
    </div>
</nav>
