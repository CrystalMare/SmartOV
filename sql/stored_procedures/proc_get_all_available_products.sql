...
--   IF (SELECT GEBOORTEDATUM
--             FROM dbo.KAART
--               JOIN dbo.PERSOONLIJKE_KAART ON KAART.KAARTID = PERSOONLIJKE_KAART.KAARTID
--               JOIN dbo.PERSOON ON PERSOONLIJKE_KAART.PERSOONID = PERSOON.PERSOONID
--             WHERE KAARTID = @kaartid) < DATEADD(YY, -65, GETDATE())
