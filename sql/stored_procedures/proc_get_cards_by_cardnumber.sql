IF OBJECT_ID('PROC_GET_CARD_BY_CARDNUMBER', 'P') IS NOT NULL -- EXAMPLE PROCEDURE NAME
  DROP PROCEDURE PROC_GET_CARD_BY_CARDNUMBER
GO

-- CREATE STORED PROCEDURE
CREATE PROCEDURE PROC_GET_CARD_BY_CARDNUMBER -- EXAMPLE NAME
    @cardnumber char(16), -- EXAMPLE PARAMETERS
    @detailed bit = 0
AS
